my_models.py: my mini library encompassing Linear and Logistic Regression models coded by me from scratch in numpy! It has automatic weight assignment using np.zeros, 
